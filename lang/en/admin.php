...
<p>The language files are available in the <code>/lang/:code</code> directory.</p>
	...
	'guest_can_contact_authors_hint' => 'Allow guests to contact ads authors. If unchecked, only registered users can contact ads authors and can see the ads authors phone number.',
	...
	'guest_can_submit_listings_hint' => 'Allow guests to post ads. If unchecked, only registered users can post ads.',
...
<br>This feature is not to be confused with the <a href="#admin#/languages" class="btn btn-dark">Languages</a> management (adding, editing, deleting languages or setting a language as default language).</p>
	...
	'diacritic_sensitive_search_label' => 'Diacritic-Sensitive Search',
	'diacritic_sensitive_search_hint' => 'When enabled, search will distinguish between accented and non-accented characters (e.g., "café" vs "cafe"). When disabled, diacritics are ignored for broader search results.',
...
<li><strong>ResizeCanvas</strong>: Resize image boundaries.</li>
	...
	'img_resize_large_sep_value' => '<h4><strong>C) Big Thumbnails (Companies logos)</strong></h4>',
...
<br><strong>Warning:</strong> By selecting the v3, you have to check browser compatibility... The "fetch()" function has compatibility issues with some browser like IE.',
	...
	'recaptcha_v3_score_threshold_label' => 'reCAPTCHA (v3) Score Threshold',
	'recaptcha_v3_score_threshold_hint' => 'Minimum score required to pass reCAPTCHA v3 validation. Scores range from 0.0 (bot) to 1.0 (human). Google recommends 0.5 as a starting point. Lower values are more lenient, higher values are stricter.',
...
<li>To save this form regardless of the validity of the filled parameters, you have to uncheck this field.</li>
    ...
    'two_factor_enabled_label' => 'Enable Two-Factor Authentication',
    'two_factor_enabled_hint' => 'Allow users to enable 2FA for their accounts for enhanced security.',
    'two_factor_method_label' => '2FA Method',
    'two_factor_method_hint' => 'Choose the default method for two-factor authentication.',
    'two_factor_method_totp' => 'Authenticator App (TOTP)',
    'two_factor_method_email' => 'Email Verification Code',
    'two_factor_method_sms' => 'SMS Verification Code',
    'account_lockout' => 'Account Lockout',
    'account_lockout_enabled_label' => 'Enable Account Lockout',
    'account_lockout_enabled_hint' => 'Lock user accounts after too many failed login attempts.',
    'max_login_attempts_label' => 'Maximum Login Attempts',
    'max_login_attempts_hint' => 'Number of failed login attempts before the account is locked.',
    'lockout_duration_label' => 'Lockout Duration (minutes)',
    'lockout_duration_hint' => 'How long the account should be locked after exceeding max attempts.',
    ...
    'password_require_uppercase_label' => 'Require Uppercase Letter',
    'password_require_uppercase_hint' => 'Require at least one uppercase letter in passwords.',
    'password_require_number_label' => 'Require Number',
    'password_require_number_hint' => 'Require at least one number in passwords.',
    'password_require_special_label' => 'Require Special Character',
    'password_require_special_hint' => 'Require at least one special character in passwords.',
    'session_settings' => 'Session Settings',
    'session_timeout_label' => 'Session Timeout (minutes)',
    'session_timeout_hint' => 'Automatically log out users after this period of inactivity.',
    'single_session_label' => 'Single Session Only',
    'single_session_hint' => 'Allow users to be logged in from only one device at a time.',
    'user_suspended_notification' => 'Your account has been suspended.',
    'user_banned_notification' => 'Your account has been banned.',
    'account_locked_notification' => 'Your account has been temporarily locked due to too many failed login attempts. Please try again in :minutes minutes.',

    // Recruiter Company Limit
    'recruiter_company_sep_value' => '<h3>Company Creation Limit</h3>',
    'recruiter_company_limit_label' => 'Recruiter Company Limit',
    'recruiter_company_limit_hint' => 'Control whether recruiters can create multiple companies or just one.',
