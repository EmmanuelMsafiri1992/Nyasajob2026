...
use App\Http\Requests\Admin\AdPackageRequest as StoreRequest;
use App\Http\Requests\Admin\AdPackageRequest as UpdateRequest;

class AdPackageController extends PanelController
{
	public function setup()
	{
		...
		|--------------------------------------------------------------------------
		*/
		$this->xPanel->setModel('App\Models\AdPackage');
		$this->xPanel->setRoute(admin_uri('ad_packages'));
		$this->xPanel->setEntityNameStrings(trans('admin.ad_package'), trans('admin.ad_packages'));
		...
		*/
		...
		$this->xPanel->addColumn([
			'name'  => 'duration_days',
			'label' => trans('admin.Duration (Days)'),
		]);
		$this->xPanel->addColumn([
			'name'          => 'first_position',
			'label'         => trans('admin.First Position'),
			'type'          => 'model_function',
		...
		$this->xPanel->addField([
			'name'              => 'duration_days',
			'label'             => trans('admin.ad_duration_days'),
			'type'              => 'number',
			'attributes'        => [
			...
			'hint'              => trans('admin.ad_duration_days_hint'),
			'wrapperAttributes' => [
				'class' => 'col-md-6',
			],
		]);
		$this->xPanel->addField([
			'name'              => 'first_position',
			'label'             => trans('admin.first_position'),
			'type'              => 'checkbox_switch',
			'hint'              => trans('admin.first_position_hint'),
			'wrapperAttributes' => [
				'class' => 'col-md-6',
		...
		$this->xPanel->addField([
			...
			'label'             => trans('admin.impressions_limit'),
			'type'              => 'number',
			'attributes'        => [
				'min'  => 0,
				'step' => 1,
			],
			'hint'              => trans('admin.impressions_limit_hint'),
			'wrapperAttributes' => [
				'class' => 'col-md-6',
			],
		]);
		$this->xPanel->addField([
			'name'              => 'clicks_limit',
			'label'             => trans('admin.clicks_limit'),
			'type'              => 'number',
			'attributes'        => [
				'min'  => 0,
				'step' => 1,
			],
			'hint'              => trans('admin.clicks_limit_hint'),
			'wrapperAttributes' => [
				'class' => 'col-md-6',
			],
		]);
		...
		$this->xPanel->addField([
			...
			'hint'       => trans('admin.ad_package_description_hint'),
		]);
		$this->xPanel->addField([
			'name'              => 'lft',
