	...
	public function applyFrontSettings()
	{
		...
		*/
		...
		try {
			...
			$infeedAdvertising = cache()->remember('advertising.infeed', $this->cacheExpiration, function () {
				return Advertising::where('integration', 'unitSlot')->where('slug', 'infeed')->first();
			});
		} catch (\Throwable $e) {
		}
		...
		view()->share('infeedAdvertising', $infeedAdvertising);
