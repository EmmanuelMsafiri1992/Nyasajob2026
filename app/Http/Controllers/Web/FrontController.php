		...
		if (in_array(auth()->user()->user_type_id, [2])) {
			$menuArray = [
				...
				[
					...
					'countVar'   => null,
					'inDropdown' => true,
					'isActive'   => (request()->segment(2) == 'subscriptions'),
				],
				[
					'name'       => t('Job Preferences'),
					'url'        => url('account/job-preferences'),
					'icon'       => 'fas fa-sliders-h',
					'group'      => t('my_ads'),
					'countVar'   => null,
					'inDropdown' => true,
					'isActive'   => (request()->segment(2) == 'job-preferences'),
				],
				[
					'name'       => t('Job Matches'),
					'url'        => url('account/job-matches'),
					'icon'       => 'fas fa-bullseye',
					'group'      => t('my_ads'),
					'countVar'   => 'jobMatches',
					'inDropdown' => true,
					'isActive'   => (request()->segment(2) == 'job-matches'),
				],
				[
